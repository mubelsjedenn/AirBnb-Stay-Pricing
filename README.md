# AirBnb-Stay-Pricing
In this project i have developed a machine learning model for predicting the price of AirBnb stays using regression.
Used a multitude of machine learning models for regression to select the best model for the job.
Usage of Pipelines to transform  the data for Linear and non-Parametric models.
